...
TELEGRAM_IMAGE=$(build_image "ghcr.io/mautrix/telegram:latest")
WHATSAPP_IMAGE=$(build_image "ghcr.io/mautrix/whatsapp:latest")
SIGNAL_IMAGE=$(build_image "ghcr.io/mautrix/signal:latest")
